...
export class StaffService {
  ...
  getStaffList() {
    return this.http.get(config.baseURL + 'api/users', { headers: this.header });
  }

  addNewStaff(newStaff) {
    return this.http.post(config.baseURL + 'api/users', newStaff, {headers: this.header});
  }

  editStaff(editStaff) {
    return this.http.put(config.baseURL + 'api/users/' + editStaff.id, editStaff, {headers: this.header});
  }
